// Runtime environment configuration (development defaults)
// In production, this file is generated at container startup
window.__ENV__ = {
  API_BASE_URL: "http://localhost:8080", // Fallback for backward compatibility
